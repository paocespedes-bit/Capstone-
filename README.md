# SIPstore: Plataforma de Ventas Online de Paneles SIP
![Portada](Fase%202/Evidencias%20Proyecto/Evidencias%20de%20documentacion/Imagenes%20mockup/Portada_github.png)


##  1. Introducción al Proyecto
**SIPstore** es la solución de comercio electrónico diseñada para la empresa de don José Antonio Campos. Su objetivo principal es **digitalizar el proceso de ventas** de paneles SIP, reducir errores manuales y agilizar la atención al cliente..
...
Dentro de cada fase existen tres tipos de evidencias:
...
-   **Evidencias Grupales:** Presentación inicial del proyecto, definición del proyecto (ES) y plantilla de evaluación de la fase.
***
### Fase 2
Incluye el desarrollo y avance del proyecto.

-   **Evidencias Individuales:** Diario de reflexión y avances.
-   **Evidencias Grupales:** Desarrollo del proyecto, informes finales (ES) y plantillas de evaluación.
-   **Evidencias del Proyecto:** Documentación, evidencias del sistema (aplicación) y base de datos.

### Fase 3
Corresponde al cierre del proyecto.
***
